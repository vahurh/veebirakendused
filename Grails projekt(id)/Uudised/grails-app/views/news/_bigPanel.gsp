<div class = "bigPanel">
	...
	<div class = "bigHighlight ">
		...
		<div id = "bigHighlight-photo">
			<g:link controller="article" action="show" params =  "[id:articles[0].id]">
				<img class="bigHighlight-img" src="${createLink(controller:'article', action:'displayImage', id: articles[0].id ) }" />
			</g:link>
		</div>
	...
	<div class = "bigMedium">
		...
		<div id = "bigMedium-photo">
			<g:link controller="article" action="show" params =  "[id:articles[1].id]">
				<img class="bigMedium-img" src="${createLink(controller:'article', action:'displayImage', id: articles[1].id ) }" />
			</g:link>
		</div>
